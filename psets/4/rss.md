...
Implement a phrase trigger (`PhraseTrigger`) that fires when a given phrase is in any of the subject, title, or summary. The phrase should be an argument to the class's constructor. 
